...
export async function POST(request: Request) {
  ...
  try {
    ...
    const order = {
      ...
      urlReturn: `https://kierunek-dzierganie-git-dev-kryptonum.vercel.app/api/payment/verify/?session=${session}&id=${id}`,
      urlStatus: `https://kierunek-dzierganie-git-dev-kryptonum.vercel.app/api/payment/complete/?session=${session}&id=${id}`,
      timeLimit: 60,
