...
import Notes from '../NotesSection/Notes';
import styles from './RelatedNotes.module.scss';
import type { RelatedNotesTypes } from './RelatedNotes.types';

const RelatedNotes = ({ notes, courseName }: RelatedNotesTypes) => {
