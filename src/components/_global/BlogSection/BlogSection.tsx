...
const BlogSection = async ({ data: { blog_Heading, blog_Paragraph, blog_HighlightedPost, slug } }: BlogSectionTypes) => {
  return (
    <section className={styles['BlogSection']}>
      ...
      <HighlightedPost blog_HighlightedPost={blog_HighlightedPost} slug={slug}/>
      <BlogPosts slug={slug}/>
    </section>
  );
};
